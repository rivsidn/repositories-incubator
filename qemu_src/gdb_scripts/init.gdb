...
set args -m 1024 -smp 2 -hda /home/yuchao/Downloads/test.img --enable-kvm -vnc :1 -device edu,id=edu1 -device edu,id=edu2 -monitor tcp:127.0.0.1:2345,server,nowait
